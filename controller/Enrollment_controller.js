...
exports.CreateEnrollmentDetails = async(req,res)=>{
    try {       
        const result1 = await Enrollment.create(
            {
                ...
                },
            {
                ...
                var  transporter = nodemailer.createTransport({
                    ...
                    <div align="center" class="alignment" style="line-height:10px"><img alt="book shelf" class="big" src="https://paymentgateway01.scm.azurewebsites.net/dev/api/files/wwwroot/images/images/online-g7c8f8b8b0_1280.png" style="display: block; height: auto; border: 0; width: 560px; max-width: 100%;" title="book shelf" width="560"/></div>
                    </td>
                    </tr>
                    </table>
                    </td>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-3" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ff7d14; background-image: url('https://paymentgateway01.scm.azurewebsites.net/dev/api/files/wwwroot/images/images/orange-gradient-wide.png'); background-repeat: no-repeat;" width="100%">
                    <tbody>
                    <tr>
                    <td>
                    ...
                    <p style="margin: 0; margin-bottom: 16px;"><strong>Course Price: ${result[0].Course[0].CoursePrice}</strong></p>
                    <p style="margin: 0; margin-bottom: 16px;"><strong>No .of Lesson: ${result[0].Course[0].NoofLession}</strong></p>
                    ...
                    <tr>
                    <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                    <div align="center" class="alignment" style="line-height:10px"><img alt="audio book" src="https://paymentgateway01.scm.azurewebsites.net/dev/wwwroot/images/images/book-app.png" style="display: block; height: auto; border: 0; width: 195px; max-width: 100%;" title="audio book" width="195"/></div>
                    </td>
                    </tr>
                    </table>
                    </td>
                    ...
                    <tr>
                    <td style="padding:0 7px 0 7px;"><a href="https://www.facebook.com/" target="_blank"><img alt="Facebook" height="32" src="https://paymentgateway01.scm.azurewebsites.net/dev/api/files/wwwroot/images/images/facebook2x.png" style="display: block; height: auto; border: 0;" title="Facebook" width="32"/></a></td>
                    <td style="padding:0 7px 0 7px;"><a href="https://twitter.com/" target="_blank"><img alt="Twitter" height="32" src="https://paymentgateway01.scm.azurewebsites.net/dev/api/files/wwwroot/images/images/twitter2x.png" style="display: block; height: auto; border: 0;" title="Twitter" width="32"/></a></td>
                    <td style="padding:0 7px 0 7px;"><a href="https://instagram.com/" target="_blank"><img alt="Instagram" height="32" src="https://paymentgateway01.scm.azurewebsites.net/dev/api/files/wwwroot/images/images/instagram2x.png" style="display: block; height: auto; border: 0;" title="Instagram" width="32"/></a></td>
                    </tr>
                    </table>
                    </div>
                    </td>
                    ...
                    <tr>
                    <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                    <div align="center" class="alignment" style="line-height:10px"><img class="fullMobileWidth" src="https://paymentgateway01.scm.azurewebsites.net/dev/api/files/wwwroot/images/images/online-g7c8f8b8b0_1280.png" style="display: block; height: auto; border: 0; width: 600px; max-width: 100%;" width="600"/></div>
                    </td>
                    </tr>
                    </table>
                    <table border="0" cellpadding="0" cellspacing="0" class="text_block block-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                    ...
                    <!--<![endif]-->
                    <tr>
                    <td style="vertical-align: middle; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 5px; padding-right: 6px;"><a href="https://github.com/esparse/payment/blob/main/images/images/bee.png" style="text-decoration: none;" target="_blank"><img align="center" alt="Designed with BEE" class="icon" height="32" src="images/bee.png" style="display: block; height: auto; margin: 0 auto; border: 0;" width="34"/></a></td>
